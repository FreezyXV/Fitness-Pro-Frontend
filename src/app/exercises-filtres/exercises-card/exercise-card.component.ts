...
import { NotificationUtils, APP_CONFIG } from '../../shared/index';
...
export class ExerciseCardComponent implements OnInit, OnDestroy {
  ...
  getDifficultyIcon(difficulty: string): string {
    const difficultyInfo = APP_CONFIG.EXERCISE_CONFIG.DIFFICULTIES.find(d => d.value === difficulty);
  ...
  getBodyPartIcon(bodyPart: string): string {
    const bodyPartInfo = APP_CONFIG.EXERCISE_CONFIG.BODY_PARTS.find(bp => bp.value === bodyPart);
